...
# tlogger.debug('This is a debug msg') # 10
# tlogger.info('This is a info msg') # 20
# tlogger.warning('This is a warning msg') # 30
# tlogger.error('This is a error msg') # 40
# tlogger.critical('This is a critical msg') # 50
